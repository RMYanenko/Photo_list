...
List<PhotoList> photoListFromJson(String str) =>
    List<PhotoList>.from(json.decode(str).map((x) => PhotoList.fromJson(x)));

String photoListToJson(List<PhotoList> data) =>
...
class PhotoList {
  ...
  factory PhotoList.fromJson(Map<String, dynamic> json) => PhotoList(
        ...
        links: PhotoListLinks.fromJson(json["links"]),
...
class PhotoListLinks {
  ...
  factory PhotoListLinks.fromJson(Map<String, dynamic> json) => PhotoListLinks(
        self: json["self"],
        html: json["html"],
